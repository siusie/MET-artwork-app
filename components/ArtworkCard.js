        ...
        return (<>
            <Card>
                ...
                <Card.Body>
                    ...
                    <Link href={`/artwork/${data?.objectID}`} passHref target="_blank"><a><Button onClick={(e) => { doNavigation(e, `/artwork/${data?.objectID}`) }} variant="outline-primary">ID: {data?.objectID}</Button></a></Link>
                </Card.Body>
            </Card>
